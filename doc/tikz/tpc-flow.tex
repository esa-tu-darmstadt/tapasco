...
\begin{tikzpicture} [ line width=2pt,
    ...
    tpc/.style={font=\bfseries\Large\color{white}},
    tpc step/.style={fill=white, rounded corners, draw=esa4},
    tpc step label/.style={font=\bfseries, align=center},
  ...
  \node [tpc] (tpc) at ($(t)!.5!(m)$) {ThreadpoolComposer};

  \foreach \ts/\l in {1/{Kernel\\Preparation}, 2/{Threadpool\\Composition}, 3/{Platform\\Integration}, 4/{Evaluation}}
    \path [tpc step] ($(ts\ts |- tt) - (0.5*\tpcstepwidth,0)$) rectangle ($(ts\ts |- tb) + (0.5*\tpcstepwidth,0)$) node [pos=.5, tpc step label] {\l};
