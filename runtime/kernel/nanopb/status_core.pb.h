...
#define tapasco_status_Status_init_zero          {0, false, tapasco_status_MemoryArea_init_zero, false, tapasco_status_MemoryArea_init_zero, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
...
X(a, STATIC,   OPTIONAL, MESSAGE,  arch_base,         2) \
X(a, STATIC,   OPTIONAL, MESSAGE,  platform_base,     3) \
