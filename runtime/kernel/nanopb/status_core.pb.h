...
#define tapasco_status_PE_init_default                                         \
	{                                                                      \
		{ { NULL }, NULL }, 0, 0, 0,                                   \
			tapasco_status_MemoryArea_init_default                 \
	}
#define tapasco_status_Platform_init_default                                   \
	{                                                                      \
		{ { NULL }, NULL }, 0, 0                                       \
	}
#define tapasco_status_Clock_init_default                                      \
	{                                                                      \
		{ { NULL }, NULL }, 0                                          \
	}
#define tapasco_status_Version_init_default                                    \
	{                                                                      \
		{ { NULL }, NULL }, 0, 0,                                      \
		{                                                              \
			{ NULL }, NULL                                         \
...
#define tapasco_status_MemoryArea_init_default                                 \
	{                                                                      \
		0, 0                                                           \
	}
#define tapasco_status_Status_init_default                                     \
	{                                                                      \
		0, tapasco_status_MemoryArea_init_default,                     \
			tapasco_status_MemoryArea_init_default,                \
			{ { NULL }, NULL }, { { NULL }, NULL },                \
			{ { NULL }, NULL },                                    \
		{                                                              \
...
#define tapasco_status_PE_init_zero                                            \
	{                                                                      \
		{ { NULL }, NULL }, 0, 0, 0,                                   \
			tapasco_status_MemoryArea_init_zero                    \
	}
#define tapasco_status_Platform_init_zero                                      \
	{                                                                      \
		{ { NULL }, NULL }, 0, 0                                       \
	}
#define tapasco_status_Clock_init_zero                                         \
	{                                                                      \
		{ { NULL }, NULL }, 0                                          \
	}
#define tapasco_status_Version_init_zero                                       \
	{                                                                      \
		{ { NULL }, NULL }, 0, 0,                                      \
		{                                                              \
			{ NULL }, NULL                                         \
...
#define tapasco_status_MemoryArea_init_zero                                    \
	{                                                                      \
		0, 0                                                           \
	}
#define tapasco_status_Status_init_zero                                        \
	{                                                                      \
		0, tapasco_status_MemoryArea_init_zero,                        \
			tapasco_status_MemoryArea_init_zero,                   \
			{ { NULL }, NULL }, { { NULL }, NULL },                \
			{ { NULL }, NULL },                                    \
		{                                                              \
