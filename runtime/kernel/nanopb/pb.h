...
#define PB_BIND(msgname, structname, width)                                    \
	const uint32_t structname##_field_info[] = { msgname##_FIELDLIST(      \
...
#define PB_GEN_FIELD_INFO_AUTO(structname, atype, htype, ltype, fieldname,     \
			       tag)                                            \
	PB_GEN_FIELD_INFO_AUTO2(PB_FIELDINFO_WIDTH_AUTO(atype, htype, ltype),  \
				structname, atype, htype, ltype, fieldname,    \
				tag)

#define PB_GEN_FIELD_INFO_AUTO2(width, structname, atype, htype, ltype,        \
				fieldname, tag)                                \
	PB_GEN_FIELD_INFO(width, structname, atype, htype, ltype, fieldname,   \
			  tag)

#define PB_GEN_FIELD_INFO(width, structname, atype, htype, ltype, fieldname,   \
			  tag)                                                 \
	PB_FIELDINFO_##width(                                                  \
		tag,                                                           \
...
#define PB_GEN_FIELD_INFO_ASSERT_1(structname, atype, htype, ltype, fieldname, \
				   tag)                                        \
	PB_GEN_FIELD_INFO_ASSERT(1, structname, atype, htype, ltype,           \
				 fieldname, tag)

#define PB_GEN_FIELD_INFO_ASSERT_2(structname, atype, htype, ltype, fieldname, \
				   tag)                                        \
	PB_GEN_FIELD_INFO_ASSERT(2, structname, atype, htype, ltype,           \
				 fieldname, tag)

#define PB_GEN_FIELD_INFO_ASSERT_4(structname, atype, htype, ltype, fieldname, \
				   tag)                                        \
	PB_GEN_FIELD_INFO_ASSERT(4, structname, atype, htype, ltype,           \
				 fieldname, tag)

#define PB_GEN_FIELD_INFO_ASSERT_8(structname, atype, htype, ltype, fieldname, \
				   tag)                                        \
	PB_GEN_FIELD_INFO_ASSERT(8, structname, atype, htype, ltype,           \
				 fieldname, tag)

#define PB_GEN_FIELD_INFO_ASSERT_AUTO(structname, atype, htype, ltype,         \
				      fieldname, tag)                          \
	PB_GEN_FIELD_INFO_ASSERT_AUTO2(                                        \
		PB_FIELDINFO_WIDTH_AUTO(atype, htype, ltype), structname,      \
		atype, htype, ltype, fieldname, tag)

#define PB_GEN_FIELD_INFO_ASSERT_AUTO2(width, structname, atype, htype, ltype, \
				       fieldname, tag)                         \
	PB_GEN_FIELD_INFO_ASSERT(width, structname, atype, htype, ltype,       \
				 fieldname, tag)

#define PB_GEN_FIELD_INFO_ASSERT(width, structname, atype, htype, ltype,       \
				 fieldname, tag)                               \
	PB_FIELDINFO_ASSERT_##width(                                           \
		tag,                                                           \
		PB_ATYPE_##atype | PB_HTYPE_##htype | PB_LTYPE_MAP_##ltype,    \
		PB_DATA_OFFSET_##atype(htype, structname, fieldname),          \
		PB_DATA_SIZE_##atype(htype, structname, fieldname),            \
...
#define PB_DATA_OFFSET_STATIC(htype, structname, fieldname)                    \
	PB_DATA_OFFSET_##htype(structname, fieldname)
#define PB_DATA_OFFSET_POINTER(htype, structname, fieldname)                   \
	PB_DATA_OFFSET_##htype(structname, fieldname)
#define PB_DATA_OFFSET_CALLBACK(htype, structname, fieldname)                  \
	PB_DATA_OFFSET_##htype(structname, fieldname)
#define PB_DATA_OFFSET_REQUIRED(structname, fieldname)                         \
	offsetof(structname, fieldname)
#define PB_DATA_OFFSET_SINGULAR(structname, fieldname)                         \
	offsetof(structname, fieldname)
#define PB_DATA_OFFSET_ONEOF(structname, fieldname)                            \
	offsetof(structname, PB_ONEOF_NAME(FULL, fieldname))
#define PB_DATA_OFFSET_OPTIONAL(structname, fieldname)                         \
	offsetof(structname, fieldname)
#define PB_DATA_OFFSET_REPEATED(structname, fieldname)                         \
	offsetof(structname, fieldname)
#define PB_DATA_OFFSET_FIXARRAY(structname, fieldname)                         \
	offsetof(structname, fieldname)

#define PB_SIZE_OFFSET_STATIC(htype, structname, fieldname)                    \
	PB_SIZE_OFFSET_##htype(structname, fieldname)
#define PB_SIZE_OFFSET_POINTER(htype, structname, fieldname)                   \
	PB_SIZE_OFFSET_PTR_##htype(structname, fieldname)
...
#define PB_SIZE_OFFSET_ONEOF(structname, fieldname)                            \
	PB_SIZE_OFFSET_ONEOF2(structname, PB_ONEOF_NAME(FULL, fieldname),      \
			      PB_ONEOF_NAME(UNION, fieldname))
#define PB_SIZE_OFFSET_ONEOF2(structname, fullname, unionname)                 \
	PB_SIZE_OFFSET_ONEOF3(structname, fullname, unionname)
#define PB_SIZE_OFFSET_ONEOF3(structname, fullname, unionname)                 \
	pb_delta(structname, fullname, which_##unionname)
#define PB_SIZE_OFFSET_OPTIONAL(structname, fieldname)                         \
	pb_delta(structname, fieldname, has_##fieldname)
#define PB_SIZE_OFFSET_REPEATED(structname, fieldname)                         \
...
#define PB_SIZE_OFFSET_PTR_ONEOF(structname, fieldname)                        \
	PB_SIZE_OFFSET_ONEOF(structname, fieldname)
#define PB_SIZE_OFFSET_PTR_OPTIONAL(structname, fieldname) 0
#define PB_SIZE_OFFSET_PTR_REPEATED(structname, fieldname)                     \
	PB_SIZE_OFFSET_REPEATED(structname, fieldname)
#define PB_SIZE_OFFSET_PTR_FIXARRAY(structname, fieldname) 0

#define PB_ARRAY_SIZE_STATIC(htype, structname, fieldname)                     \
	PB_ARRAY_SIZE_##htype(structname, fieldname)
...
#define PB_ARRAY_SIZE_REPEATED(structname, fieldname)                          \
	pb_arraysize(structname, fieldname)
#define PB_ARRAY_SIZE_FIXARRAY(structname, fieldname)                          \
	pb_arraysize(structname, fieldname)

#define PB_DATA_SIZE_STATIC(htype, structname, fieldname)                      \
	PB_DATA_SIZE_##htype(structname, fieldname)
#define PB_DATA_SIZE_POINTER(htype, structname, fieldname)                     \
	PB_DATA_SIZE_PTR_##htype(structname, fieldname)
#define PB_DATA_SIZE_CALLBACK(htype, structname, fieldname)                    \
	pb_membersize(structname, fieldname)
#define PB_DATA_SIZE_REQUIRED(structname, fieldname)                           \
	pb_membersize(structname, fieldname)
#define PB_DATA_SIZE_SINGULAR(structname, fieldname)                           \
	pb_membersize(structname, fieldname)
#define PB_DATA_SIZE_OPTIONAL(structname, fieldname)                           \
	pb_membersize(structname, fieldname)
#define PB_DATA_SIZE_ONEOF(structname, fieldname)                              \
	pb_membersize(structname, PB_ONEOF_NAME(FULL, fieldname))
#define PB_DATA_SIZE_REPEATED(structname, fieldname)                           \
	pb_membersize(structname, fieldname[0])
#define PB_DATA_SIZE_FIXARRAY(structname, fieldname)                           \
	pb_membersize(structname, fieldname[0])
#define PB_DATA_SIZE_PTR_REQUIRED(structname, fieldname)                       \
	pb_membersize(structname, fieldname[0])
#define PB_DATA_SIZE_PTR_SINGULAR(structname, fieldname)                       \
	pb_membersize(structname, fieldname[0])
#define PB_DATA_SIZE_PTR_OPTIONAL(structname, fieldname)                       \
	pb_membersize(structname, fieldname[0])
#define PB_DATA_SIZE_PTR_ONEOF(structname, fieldname)                          \
	pb_membersize(structname, PB_ONEOF_NAME(FULL, fieldname)[0])
#define PB_DATA_SIZE_PTR_REPEATED(structname, fieldname)                       \
	pb_membersize(structname, fieldname[0])
#define PB_DATA_SIZE_PTR_FIXARRAY(structname, fieldname)                       \
	pb_membersize(structname, fieldname[0])
...
#define PB_SUBMSG_INFO_REQUIRED(ltype, structname, fieldname)                  \
	PB_SUBMSG_INFO_##ltype(structname##_##fieldname##_MSGTYPE)
...
#define PB_SUBMSG_INFO_ONEOF(ltype, structname, fieldname)                     \
	PB_SUBMSG_INFO_ONEOF2(ltype, structname,                               \
			      PB_ONEOF_NAME(UNION, fieldname),                 \
...
#define PB_SUBMSG_INFO_ONEOF3(ltype, structname, unionname, membername)        \
	PB_SUBMSG_INFO_##ltype(                                                \
		structname##_##unionname##_##membername##_MSGTYPE)
...
#define PB_FIELDINFO_ASSERT_4(tag, type, data_offset, data_size, size_offset,  \
	...
	PB_STATIC_ASSERT(PB_FITS(tag, 16) && PB_FITS(data_offset, 16) &&       \
				 PB_FITS((int8_t)size_offset, 8) &&            \
				 PB_FITS(data_size, 16) &&                     \
...
#define PB_FIELDINFO_WIDTH_AUTO(atype, htype, ltype)                           \
	PB_FIELDINFO_WIDTH_##atype(htype, ltype)
#define PB_FIELDINFO_WIDTH_STATIC(htype, ltype)                                \
	PB_FIELDINFO_WIDTH_##htype(ltype)
#define PB_FIELDINFO_WIDTH_POINTER(htype, ltype)                               \
	PB_FIELDINFO_WIDTH_##htype(ltype)
