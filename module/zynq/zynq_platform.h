...
#define ZYNQ_PLATFORM_STATUS_BASE	(0x77770000UL)
#define ZYNQ_PLATFORM_STATUS_SIZE	(0x00002000UL)
#define ZYNQ_PLATFORM_STATUS_HIGH	(ZYNQ_PLATFORM_STATUS_BASE + \
		ZYNQ_PLATFORM_STATUS_SIZE)

#define ZYNQ_PLATFORM_GP0_BASE		(0x42000000UL)
#define ZYNQ_PLATFORM_GP0_SIZE		(0x0e000000UL)
#define ZYNQ_PLATFORM_GP0_HIGH		(ZYNQ_PLATFORM_GP0_BASE +\
		ZYNQ_PLATFORM_GP0_SIZE)

#define ZYNQ_PLATFORM_GP1_BASE		(0x81000000UL)
#define ZYNQ_PLATFORM_GP1_SIZE		(0x02000000UL)
