/**
 *  @file	TpcStatusScreen.hpp
 *  @brief	Kernel map screen for tpc-debug.
 *  @author	J. Korinth, TU Darmstadt (jk@esa.cs.tu-darmstadt.de)
 **/
#ifndef __TPC_STATUS_SCREEN_HPP__
#define __TPC_STATUS_SCREEN_HPP__
...
class TpcStatusScreen: public MenuScreen {
public:
  TpcStatusScreen(ThreadPoolComposer *tpc): MenuScreen("", vector<string>()) {
    delay_us = 10000;
  }
  virtual ~TpcStatusScreen() {}
protected:
  virtual void render() {
...
#endif /* __TPC_STATUS_SCREEN_HPP__ */
