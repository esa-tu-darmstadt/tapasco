...
dict set stdcomps   bluedma_x16          vlnv   "esa.informatik.tu-darmstadt.de:user:BlueDMA_x16:1.0"
...
dict set stdcomps   axis_arbiter         vlnv   "user.org:user:AXIS_Arbiter:1.0"
