...
//
// On Fri Aug 10 14:24:48 CEST 2018
//
//
// Ports:
// Name                         I/O  size props
...
module mkBlueDMAVivado(m32_axi_aclk,
  ...
  wire blueDMA$S_AXI_arready,
       ...
       blueDMA$interrupt_read,
       blueDMA$interrupt_write,
  ...
  // value method interrupt_write
  assign IRQ_write = blueDMA$interrupt_write ;

  // value method interrupt_read
  assign IRQ_read = blueDMA$interrupt_read ;

  // submodule blueDMA
  mkBlueDMA blueDMA(.CLK_m32_axi_aclk(m32_axi_aclk),
		    .RST_N_m32_axi_aresetn(m32_axi_aresetn),
		    .CLK_m64_axi_aclk(m64_axi_aclk),
		    .RST_N_m64_axi_aresetn(m64_axi_aresetn),
		    .CLK(s_axi_aclk),
		    .RST_N(s_axi_aresetn),
		    ...
		    .interrupt_read(blueDMA$interrupt_read),
		    .interrupt_write(blueDMA$interrupt_write));
