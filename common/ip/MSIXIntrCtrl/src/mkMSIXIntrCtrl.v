...
//
// On Wed Mar 27 14:18:02 CET 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkMSIXIntrCtrl(design_clk,
  ...
  begin
    ...
    if (S_AXI_ARESETN != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_catchInterrupt && pba_vector_0)
	$display("New pcie interrupt %d DROPPED", $signed(32'd0));
    if (S_AXI_ARESETN != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_catchInterrupt && !pba_vector_0)
	$display("New pcie interrupt %d", $signed(32'd0));
    if (S_AXI_ARESETN != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_catchInterrupt_1 && pba_vector_1)
	$display("New pcie interrupt %d DROPPED", $signed(32'd1));
    if (S_AXI_ARESETN != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_catchInterrupt_1 && !pba_vector_1)
	$display("New pcie interrupt %d", $signed(32'd1));
    if (S_AXI_ARESETN != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_catchInterrupt_3 && pba_vector_3)
	$display("New pcie interrupt %d DROPPED", $signed(32'd3));
    if (S_AXI_ARESETN != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_catchInterrupt_3 && !pba_vector_3)
	$display("New pcie interrupt %d", $signed(32'd3));
    if (S_AXI_ARESETN != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_catchInterrupt_2 && pba_vector_2)
	$display("New pcie interrupt %d DROPPED", $signed(32'd2));
    if (S_AXI_ARESETN != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_catchInterrupt_2 && !pba_vector_2)
	$display("New pcie interrupt %d", $signed(32'd2));
    if (S_AXI_ARESETN != `BSV_RESET_VALUE)
      if (sync_0$dPulse) $display("New design interrupt %d", $signed(32'd0));
    if (S_AXI_ARESETN != `BSV_RESET_VALUE)
      if (sync_1$dPulse) $display("New design interrupt %d", $signed(32'd1));
    if (S_AXI_ARESETN != `BSV_RESET_VALUE)
      if (sync_2$dPulse) $display("New design interrupt %d", $signed(32'd2));
    if (S_AXI_ARESETN != `BSV_RESET_VALUE)
      if (sync_3$dPulse) $display("New design interrupt %d", $signed(32'd3));
    if (S_AXI_ARESETN != `BSV_RESET_VALUE)
      if (sync_4$dPulse) $display("New design interrupt %d", $signed(32'd4));
    if (S_AXI_ARESETN != `BSV_RESET_VALUE)
      if (sync_5$dPulse) $display("New design interrupt %d", $signed(32'd5));
    if (S_AXI_ARESETN != `BSV_RESET_VALUE)
      if (sync_7$dPulse) $display("New design interrupt %d", $signed(32'd7));
    if (S_AXI_ARESETN != `BSV_RESET_VALUE)
      if (sync_6$dPulse) $display("New design interrupt %d", $signed(32'd6));
    if (S_AXI_ARESETN != `BSV_RESET_VALUE)
      if (sync_8$dPulse) $display("New design interrupt %d", $signed(32'd8));
    if (S_AXI_ARESETN != `BSV_RESET_VALUE)
      if (sync_9$dPulse) $display("New design interrupt %d", $signed(32'd9));
    if (S_AXI_ARESETN != `BSV_RESET_VALUE)
      if (sync_10$dPulse)
