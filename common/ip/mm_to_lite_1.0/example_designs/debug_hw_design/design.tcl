...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of mm_to_lite_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins mm_to_lite_0/S_AXI]
	connect_bd_net [get_bd_pins mm_to_lite_0/s_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins mm_to_lite_0/s_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock, reset & status pins of mm_to_lite_0 master interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_mem_interconnect/S00_AXI] [get_bd_intf_pins mm_to_lite_0/M_AXI_LITE]
	connect_bd_net [get_bd_pins mm_to_lite_0/m_axi_lite_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins mm_to_lite_0/m_axi_lite_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins mm_to_lite_0/m_axi_lite_txn_done] [get_bd_pins xlconcat_0/In0]
	connect_bd_net [get_bd_pins mm_to_lite_0/m_axi_lite_error] [get_bd_pins xlconcat_0/In1]
	connect_bd_net [get_bd_pins mm_to_lite_0/m_axi_lite_init_axi_txn] [ get_bd_pins axi_gpio_out/gpio_io_o ]


	# Auto assign address
	assign_bd_address

	# Configure address param & range of mm_to_lite_0 master interfaces..
	set_property range 16K [get_bd_addr_segs {jtag_axi_0/Data/SEG_axi_bram_ctrl_0_Mem0}]
	set_property range 16K [get_bd_addr_segs {mm_to_lite_0/M_AXI_LITE/SEG_axi_bram_ctrl_0_Mem0}]
	set_property -dict [list  CONFIG.C_M_AXI_LITE_TARGET_SLAVE_BASE_ADDR {0xC0000000} ] [get_bd_cells mm_to_lite_0]

	# Copy all address to mm_to_lite_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/mm_to_lite_v1_0_include.tcl"
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_mm_to_lite_0_S_AXI_* ]]
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/mm_to_lite_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "mm_to_lite_v1_0_hw_${i}"
