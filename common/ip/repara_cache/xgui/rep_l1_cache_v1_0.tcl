...
source [file join [file dirname [file dirname [info script]]] gui/rep_l1_cache_v1_0.gtcl]
...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_CACHELINE_DATA_WIDTH" -parent ${Page_0} -widget comboBox
  ...
  ipgui::add_param $IPINST -name "C_MF_AXI_DATA_WIDTH" -parent ${Page_0} -widget comboBox
  ipgui::add_param $IPINST -name "C_SF_AXI_ADDR_WIDTH" -parent ${Page_0} -widget comboBox
  ipgui::add_param $IPINST -name "C_SF_AXI_DATA_WIDTH" -parent ${Page_0} -widget comboBox
  ...
  ipgui::add_param $IPINST -name "C_WR_STRATEGY" -parent ${Page_0} -widget comboBox
  ipgui::add_param $IPINST -name "C_RAM_TYPE" -parent ${Page_0} -widget comboBox


}

proc update_PARAM_VALUE.C_MF_AXI_ADDR_WIDTH { PARAM_VALUE.C_MF_AXI_ADDR_WIDTH PARAM_VALUE.C_SF_AXI_ADDR_WIDTH } {
	# Procedure called to update C_MF_AXI_ADDR_WIDTH when any of the dependent parameters in the arguments change
	
	set C_MF_AXI_ADDR_WIDTH ${PARAM_VALUE.C_MF_AXI_ADDR_WIDTH}
	set C_SF_AXI_ADDR_WIDTH ${PARAM_VALUE.C_SF_AXI_ADDR_WIDTH}
	set values(C_SF_AXI_ADDR_WIDTH) [get_property value $C_SF_AXI_ADDR_WIDTH]
	set_property value [gen_USERPARAMETER_C_MF_AXI_ADDR_WIDTH_VALUE $values(C_SF_AXI_ADDR_WIDTH)] $C_MF_AXI_ADDR_WIDTH
}
...
proc update_PARAM_VALUE.C_SL_AXI_ADDR_WIDTH { PARAM_VALUE.C_SL_AXI_ADDR_WIDTH PARAM_VALUE.C_SF_AXI_ADDR_WIDTH } {
	# Procedure called to update C_SL_AXI_ADDR_WIDTH when any of the dependent parameters in the arguments change
	
	set C_SL_AXI_ADDR_WIDTH ${PARAM_VALUE.C_SL_AXI_ADDR_WIDTH}
	set C_SF_AXI_ADDR_WIDTH ${PARAM_VALUE.C_SF_AXI_ADDR_WIDTH}
	set values(C_SF_AXI_ADDR_WIDTH) [get_property value $C_SF_AXI_ADDR_WIDTH]
	set_property value [gen_USERPARAMETER_C_SL_AXI_ADDR_WIDTH_VALUE $values(C_SF_AXI_ADDR_WIDTH)] $C_SL_AXI_ADDR_WIDTH
}
