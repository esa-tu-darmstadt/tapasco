...
set_max_delay -datapath_only -from [get_pins {system_i/network/mrmac_port_*_cell/mrmac_port_*/inst/i_system_mrmac_port_*_versal_gt_reset_controller_0/inst/use_master_reset.system_mrmac_port_*_versal_gt_reset_controller_0_master_reset_synchronizer_gtwiz_reset_all_inst_rx_1/syncstages_ff_reg[2]/C}] -to [get_pins -hierarchical -filter {NAME =~ */SFP_*_reciever/reciever_sync/s*_couplers/auto_cc/inst/gen_async_conv.axisc_async_clock_converter_*/s_and_m_areset_r_reg/D}] $mrmac_clk_period
set_max_delay -datapath_only -from [get_pins {system_i/network/mrmac_port_*_cell/mrmac_port_*/inst/i_system_mrmac_port_*_versal_gt_reset_controller_0/inst/use_master_reset.system_mrmac_port_*_versal_gt_reset_controller_0_master_reset_synchronizer_gtwiz_reset_all_inst_rx_1/syncstages_ff_reg[2]/C}] -to [get_pins -hierarchical -filter {NAME =~ */SFP_*_reciever/reciever_sync/s00_couplers/auto_us/inst/areset_r_reg/D}] $mrmac_clk_period
set_max_delay -datapath_only -from [get_pins {system_i/network/mrmac_port_*_cell/mrmac_port_*/inst/i_system_mrmac_port_*_0_versal_gt_reset_controller_0/inst/use_master_reset.system_mrmac_port_*_0_versal_gt_reset_controller_0_master_reset_synchronizer_gtwiz_reset_all_inst_tx_1/syncstages_ff_reg[2]/C}] -to [get_pins -hierarchical -filter {NAME =~ */SFP_port_*_transmitter/transmitter_sync/s00_couplers/auto_ds/inst/areset_r_reg/D}] $mrmac_clk_period

# avoid pulse width violation in sync ICs for networking
set_property OREG_B TRUE [get_cells {system_i/arch/SFP_*_transmitter/transmitter_sync/s00_couplers/s00_data_fifo/inst/gen_fifo.xpm_fifo_axis_inst/xpm_fifo_base_inst/gen_sdpram.xpm_memory_base_inst/gen_wr_a.gen_word_narrow.mem_reg_uram_*}]
