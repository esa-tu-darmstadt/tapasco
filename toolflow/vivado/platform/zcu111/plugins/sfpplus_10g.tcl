...
namespace eval sfpplus {
  ...
  namespace eval 10g {
    ...
    variable refclk_pins           {"V31" "V32"}
    variable gt_quads              {"Quad_X0Y1" "Quad_X0Y2" "Quad_X0Y3" "Quad_X0Y4"}
    variable gt_lanes              {"X0Y4" "X0Y5" "X0Y6" "X0Y7" "X0Y8" "X0Y9" "X0Y10" "X0Y11" "X0Y12" "X1Y13" "X1Y14" "X1Y15" "X1Y16" "X1Y17" "X1Y18" "X1Y19"}
    ...
    proc generate_cores {ports} {
      ...
      connect_bd_net [get_bd_pins $axi_config/S00_ACLK] [get_bd_pins host_clk]
      connect_bd_net [get_bd_pins $axi_config/S00_ARESETN] [get_bd_pins host_interconnect_aresetn]
      connect_bd_net [get_bd_pins $axi_config/ACLK] [get_bd_pins host_clk]
      connect_bd_net [get_bd_pins $axi_config/ARESETN] [get_bd_pins host_interconnect_aresetn]
