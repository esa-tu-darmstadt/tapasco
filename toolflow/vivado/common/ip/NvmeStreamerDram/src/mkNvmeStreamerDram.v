...
//
// On Tue Jan 27 17:15:22 CET 2026
//
//
// Ports:
// Name                         I/O  size props
...
module mkNvmeStreamerDram(aclk,
  ...
  wire [13 : 0] _0_CONCAT_nvmeCmdWriteCount_BITS_13_TO_6_PLUS_1__q11,
		...
		x__h97205,
		y__h96420;
  wire [11 : 0] y__h101676, y__h98926;
  wire [8 : 0] b__h92774,
	       x__h102843,
	       x__h103010,
	       x__h24657,
  ...
  wire [6 : 0] x__h100268, x__h100451;
  ...
  SizedFIFO0 #(.p1depth(32'd16),
	       .p2cntr_width(32'd5),
	       .guarded(1'd1)) writeDataCompletionFifo(.RST(aresetn),
						       .CLK(aclk),
  ...
  assign MUX_axiDdrRd_in$enq_1__VAL_1 =
	     { 1'd0,
	       ...
	       IF_readBeatsToRequest_176_ULT_64_182_THEN_read_ETC___d1185,
	       21'd1642496 } ;
  assign MUX_baseAddressRegFile$upd_2__VAL_1 = { 1'd0, x__h96895 } ;
  assign MUX_baseAddressRegFile$upd_2__VAL_2 = { 1'd1, x__h97205 } ;
  ...
  assign cmd_completed$port0__write_1 = cmd_completed & y__h97667 ;
  assign cmd_completed$port1__write_1 = x__h98021 | y__h98022 ;
  ...
  assign current_completion_index$D_IN =
	     current_completion_index[63] ? 64'd1 : x__h97780 ;
  ...
  // register pcieReadDataBuffer_rRdPtr
  assign pcieReadDataBuffer_rRdPtr$D_IN = x__h100451 ;
  assign pcieReadDataBuffer_rRdPtr$EN = CAN_FIRE_RL_pcieReadResponse ;

  // register pcieReadDataBuffer_rWrPtr
  assign pcieReadDataBuffer_rWrPtr$D_IN = x__h100268 ;
  ...
  // register pcieWriteDataBuffer_rRdPtr
  assign pcieWriteDataBuffer_rRdPtr$D_IN = x__h103010 ;
  assign pcieWriteDataBuffer_rRdPtr$EN = CAN_FIRE_RL_deqPcieWriteData ;

  // register pcieWriteDataBuffer_rWrPtr
  assign pcieWriteDataBuffer_rWrPtr$D_IN = x__h102843 ;
  ...
  assign pcieToDdrReadRqFifo$D_IN =
		 ...
		 { newAddr__h99327, 8'd63, nextPcieReadRq_rv[20:0] } :
  ...
  assign IF_NOT_host_ddr_31_AND_forwardPcieWriteRqWire__ETC___d1692 =
	     (!host_ddr && CAN_FIRE_RL_forwardPcieWriteRq) ?
	       ...
	       { addr__h103821, ddrWriteReqFifo$D_OUT[7:0], 21'd1642496 } ;
  ...
  assign nextPcieReadRq_rv_port0__read__454_BITS_40_TO__ETC___d1472 =
	     nextPcieReadRq_rv[40:29] == y__h98926 ;
  ...
  assign nextPcieWriteRq_rv_port0__read__583_BITS_40_TO_ETC___d1600 =
	     nextPcieWriteRq_rv[40:29] == y__h101676 ;
  ...
  assign x__h100259 =
	     pcieReadDataBuffer_pwEnqueue$whas ?
	       ...
	       512'd0 ;
  assign x__h100268 = pcieReadDataBuffer_rWrPtr + 7'd1 ;
  assign x__h100451 = pcieReadDataBuffer_rRdPtr + 7'd1 ;
  assign x__h101801 =
	     { ddrBaseAddrWritePrefix[37:1],
	       currentPcieWritePfn[14:0],
	       12'h0 } ;
  assign x__h102843 = pcieWriteDataBuffer_rWrPtr + 9'd1 ;
  assign x__h103010 = pcieWriteDataBuffer_rRdPtr + 9'd1 ;
  ...
  assign x__h96895 = nextWriteCmdFifo$D_OUT[14:1] + 14'd1 ;
  assign x__h96995 =
	     nextWriteCmdFifo_first__374_BITS_204_TO_194_37_ETC___d1376 ?
	       nextWriteCmdFifo$D_OUT[161:98] :
	       y_avValue_prp2__h97227 ;
  assign x__h97205 = nextReadCmdFifo$D_OUT[14:1] + 14'd1 ;
  assign x__h97303 =
	     nextReadCmdFifo_first__401_BITS_210_TO_200_402_ETC___d1403 ?
	       nextReadCmdFifo$D_OUT[167:104] :
	       y_avValue_prp2__h97227 ;
  assign x__h97780 = { current_completion_index[62:0], 1'd0 } ;
  assign x__h98021 =
	     CAN_FIRE_RL_nvme_process_completion ?
  ...
  assign x_data__h21889 =
	     { IF_activeCSRRead_18_BITS_22_TO_10_27_EQ_0x0_28_ETC___d654,
	       CASE_activeCSRRead_BITS_22_TO_10_0x0_doorbell__ETC__q8,
	       CASE_activeCSRRead_BITS_22_TO_10_0x0_doorbell__ETC__q9 } ;
  assign y__h101676 = { currentPcieWriteLen[5:0], 6'd0 } ;
  assign y__h96077 = { 44'd0, nvmeCmdWriteCount[13:6] } ;
  assign y__h96420 = { 5'd0, writeSubmissionFifo$D_OUT[23:15] } ;
  assign y__h97667 = ~current_completion_index ;
  assign y__h98022 =
	     64'd1 << nvme_queues_completion_queue_0_BITS_7_TO_0__q1[5:0] ;
  assign y__h98926 = { pcieReadRequestedCount[5:0], 6'd0 } ;
  assign y_avValue_prp2__h97227 =
