...
//
// On Fri Oct 13 18:40:36 CEST 2023
//
//
// Ports:
// Name                         I/O  size props
...
module mkQDMADescriptorGenerator(aclk,
  ...
  wire [63 : 0] v__h10063, y__h18114, y__h18643;
  wire [31 : 0] y__h18060, y__h18609, y__h18916, y__h19291;
  wire [15 : 0] transferLen__h17827,
		transferLen__h18397,
		transferLen__h18857,
		transferLen__h19178;
  ...
  assign MUX_axiCtrlSlave_readSlave_out$enq_1__VAL_3 =
	     { transferLenReg, 2'd0 } ;
  assign MUX_axiCtrlSlave_readSlave_out$enq_1__VAL_4 = { v__h10063, 2'd0 } ;
  assign MUX_c2hCurrReadAddr$write_1__VAL_1 = c2hCurrReadAddr + y__h18114 ;
  assign MUX_c2hCurrWriteAddr$write_1__VAL_1 = c2hCurrWriteAddr + y__h18114 ;
  assign MUX_c2hOutstandingReg$write_1__VAL_1 =
	     c2hOutstandingReg - y__h18060 ;
  ...
  assign MUX_c2hStreamOutstandingReg$write_1__VAL_2 =
	     c2hStreamOutstandingReg - y__h18916 ;
  assign MUX_h2cCurrReadAddr$write_1__VAL_1 = h2cCurrReadAddr + y__h18643 ;
  assign MUX_h2cCurrWriteAddr$write_1__VAL_1 = h2cCurrWriteAddr + y__h18643 ;
  assign MUX_h2cOutstandingReg$write_1__VAL_1 =
	     h2cOutstandingReg - y__h18609 ;
  ...
  assign MUX_h2cStreamOutstandingReg$write_1__VAL_1 =
	     h2cStreamOutstandingReg - y__h19291 ;
  ...
  // remaining internal signals
  assign transferLen__h17827 =
	     (c2hOutstandingReg[31:16] == 16'd0) ?
	       c2hOutstandingReg[15:0] :
	       16'h8000 ;
  assign transferLen__h18397 =
	     (h2cOutstandingReg[31:16] == 16'd0) ?
	       h2cOutstandingReg[15:0] :
	       16'h8000 ;
  assign transferLen__h18857 =
	     (c2hStreamOutstandingReg[31:15] == 17'd0) ?
	       c2hStreamOutstandingReg[15:0] :
	       16'h8000 ;
  assign transferLen__h19178 =
	     (h2cStreamOutstandingReg[31:16] == 16'd0) ?
	       h2cStreamOutstandingReg[15:0] :
	       16'h8000 ;
  assign v__h10063 = { 63'd0, dmaResetActive } ;
  assign y__h18060 = { 16'd0, transferLen__h17827 } ;
  assign y__h18114 = { 48'd0, transferLen__h17827 } ;
  assign y__h18609 = { 16'd0, transferLen__h18397 } ;
  assign y__h18643 = { 48'd0, transferLen__h18397 } ;
  assign y__h18916 = { 16'd0, transferLen__h18857 } ;
  assign y__h19291 = { 16'd0, transferLen__h19178 } ;
