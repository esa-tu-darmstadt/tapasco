...
//
// On Fri Oct  1 14:11:55 UTC 2021
//
//
// Ports:
// Name                         I/O  size props
...
module mkQDMADescriptorGenerator(aclk,
  ...
  wire [63 : 0] v__h8042, y__h15861, y__h16413;
  wire [31 : 0] y__h15807, y__h16379;
  wire [15 : 0] transferLen__h15551, transferLen__h16144;
  ...
  assign MUX_axiCtrlSlave_readSlave_out$enq_1__VAL_3 =
	     { transferLenReg, 2'd0 } ;
  assign MUX_axiCtrlSlave_readSlave_out$enq_1__VAL_4 = { v__h8042, 2'd0 } ;
  assign MUX_c2hCurrReadAddr$write_1__VAL_1 = c2hCurrReadAddr + y__h15861 ;
  assign MUX_c2hCurrWriteAddr$write_1__VAL_1 = c2hCurrWriteAddr + y__h15861 ;
  assign MUX_c2hOutstandingReg$write_1__VAL_1 =
	     c2hOutstandingReg - y__h15807 ;
  assign MUX_h2cCurrReadAddr$write_1__VAL_1 = h2cCurrReadAddr + y__h16413 ;
  assign MUX_h2cCurrWriteAddr$write_1__VAL_1 = h2cCurrWriteAddr + y__h16413 ;
  assign MUX_h2cOutstandingReg$write_1__VAL_1 =
	     h2cOutstandingReg - y__h16379 ;
  ...
  // remaining internal signals
  assign transferLen__h15551 =
	     (c2hOutstandingReg[31:16] == 16'd0) ?
	       c2hOutstandingReg[15:0] :
	       16'h8000 ;
  assign transferLen__h16144 =
	     (h2cOutstandingReg[31:16] == 16'd0) ?
	       h2cOutstandingReg[15:0] :
	       16'h8000 ;
  assign v__h8042 = { 63'd0, dmaResetActive } ;
  assign y__h15807 = { 16'd0, transferLen__h15551 } ;
  assign y__h15861 = { 48'd0, transferLen__h15551 } ;
  assign y__h16379 = { 16'd0, transferLen__h16144 } ;
  assign y__h16413 = { 48'd0, transferLen__h16144 } ;
