...
dict set stdcomps   ultra_ps         vlnv   "xilinx.com:ip:zynq_ultra_ps_e:3.5"
dict set stdcomps   xxv_ethernet     vlnv   "xilinx.com:ip:xxv_ethernet:5.0"
dict set stdcomps   100g_ethernet    vlnv   "xilinx.com:ip:cmac_usplus:3.1"
dict set stdcomps   aurora           vlnv   "xilinx.com:ip:aurora_64b66b:13.0"
...
dict set stdcomps   qdma             vlnv   "xilinx.com:ip:qdma:5.1"
