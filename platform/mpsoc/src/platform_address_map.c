    ...
    platform_slot_region_id_t const region_id)
{
	...
	return 0xA1000000 + slot_id * 0x00010000;
}
...
{
	switch (ent) {
	case PLATFORM_SPECIAL_CTL_STATUS: return 0xA0000000;
	case PLATFORM_SPECIAL_CTL_INTC0 : return 0xB0000000;
	case PLATFORM_SPECIAL_CTL_INTC1 : return 0xB0010000;
	case PLATFORM_SPECIAL_CTL_INTC2 : return 0xB0020000;
	case PLATFORM_SPECIAL_CTL_INTC3 : return 0xB0030000;
