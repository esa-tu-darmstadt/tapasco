...
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.Common
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.base._
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.base.tcl._
...
class VivadoComposer()(implicit cfg: Configuration) extends Composer {
  ...
  private[this] val logger = de.tu_darmstadt.cs.esa.threadpoolcomposer.Logging.logger(this.getClass)
