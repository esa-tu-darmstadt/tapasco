...
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.itpc.view.dse.graph._
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.itpc.view.dse.graph.jung._
 ...
 */
protected[itpc] object Graph extends Publisher {
