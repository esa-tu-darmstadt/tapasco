package de.tu_darmstadt.cs.esa.threadpoolcomposer.itpc.model
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.itpc.globals._
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.dse.Exploration
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.dse.log._
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.util._
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.util.LogFormatter._
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.activity.composers.Composer
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.dse.DesignSpace
 ...
 * Elements a the [[de.tu_darmstadt.cs.esa.threadpoolcomposer.dse.DesignSpace.Element]]
...
class DesignSpaceGraph extends DirectedSparseMultigraph[N, E] with Listener[Exploration.Event] {
  ...
  private[this] val _logger = de.tu_darmstadt.cs.esa.threadpoolcomposer.Logging.logger(getClass)
...
object DesignSpaceGraph {
  /** Node type: [[de.tu_darmstadt.cs.esa.threadpoolcomposer.dse.DesignSpace.Element]]. */
