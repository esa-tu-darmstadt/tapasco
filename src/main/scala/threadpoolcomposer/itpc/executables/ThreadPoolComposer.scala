package de.tu_darmstadt.cs.esa.threadpoolcomposer.itpc.executables
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.itpc.controller._
...
class ThreadPoolComposer(mainController: ViewController) extends SimpleSwingApplication {
  import ThreadPoolComposer._
...
private object ThreadPoolComposer {
