...
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.itpc.executables._
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.itpc.globals._
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.base.Configuration
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.base.json._
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.jobs.DesignSpaceExplorationJob
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.slurm._
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.util.Listener
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.itpc.model.AppState
...
class AppController(oc: Option[Configuration]) {
  ...
  private[this] val _app   = new ThreadPoolComposer(_cfgc)
