...
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.util.Publisher
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.activity.composers.{Composer, ComposeResult}
