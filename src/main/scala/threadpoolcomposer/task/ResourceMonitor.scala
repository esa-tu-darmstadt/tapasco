...
import  de.tu_darmstadt.cs.esa.threadpoolcomposer.util.{MemInfo, FlexLicenceManagerStatus}
...
private class DefaultResourceMonitor extends ResourceMonitor {
  ...
  private val logger = de.tu_darmstadt.cs.esa.threadpoolcomposer.Logging.logger(getClass)
